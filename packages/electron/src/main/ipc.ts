...
ipcMain.handle(IPC_CHANNELS.appListCliProxyProviders, (_event, request: CliProxyProviderListRequest) => {
  return listCliProxyProviders(request);
});
