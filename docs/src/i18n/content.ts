    ...
    pages: {
      ...
      guides: {
        ...
        sidebarLinks: {
          ...
          "按 Agent 指定模型": "/guides/per-agent-models/",
      ...
      configuration: {
        ...
        sidebarLinks: {
          ...
          配置数据库位置: "/configuration/config-file/",
        },
        sidebarTargets: {},
      },
      troubleshooting: {
    ...
    pages: {
      ...
      guides: {
        ...
        sidebarLinks: {
          ...
          "Per-Agent Model Routing": "/en/guides/per-agent-models/",
